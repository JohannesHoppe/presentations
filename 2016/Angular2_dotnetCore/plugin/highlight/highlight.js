...
/*
included languages: cs, css, diff, xml (& html), http, json, javascript, markdown, typescript
hacked language: bash with "keyword" $
*/
...
hljs.registerLanguage("bash", function(e) {
    ...
    return {
        aliases: ["sh", "zsh"],
		// HACK - this is the "lexemes" - extended to support char $
        l: /-?[a-z\.$]+/,
        k: {
            keyword: "if then else elif fi for while in do done case esac function",
            literal: "true false",
			// HACK - here we add the $ to the list of build_in keywords
